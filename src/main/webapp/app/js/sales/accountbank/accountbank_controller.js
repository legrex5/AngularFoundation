 ...
 **/
salesModule.controller('SalesAccountbankCtrl', ['Accountbank',  'Salesorder', 'Useraccess', 'Bank', 'Supplier', '$scope', '$routeParams', '$http', '$location', '$cookies', 'MessageHandler', 'restURLSales', function(Accountbank, Salesorder, Useraccess, Bank, Supplier, $scope, $routeParams, $http, $location, $cookies, MessageHandler, restURLSales) {
    ...
    $scope.goToAccountbankList = function() {
        ...
        $location.path('/app/sales/accountbank');
    }
    /**
    ...
    $scope.goToAccountbank = function(accountbankid) {
        ...
        $location.path('/app/sales/accountbank/'+accountbankid);
    }
