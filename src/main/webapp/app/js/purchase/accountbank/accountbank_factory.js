 ...
 */
purchaseModule.factory('PurchaseAccountbank', ['$http', 'restURLPurchase', function($http, restURLPurchase) {

	// REST Service URL to manage accountbank
    var entityURL = restURLPurchase + '/accountbank';
	...
	return {
    	...
    	getAllAsListItems: function() {
        	return $http.get(restURLPurchase + '/items/accountbank');
    	},
